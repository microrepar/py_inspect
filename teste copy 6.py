...
from PySide2.QtWidgets import (
    QAction, QApplication, QHBoxLayout, QHeaderView, QLabel, QLineEdit,
...
class Widget(QWidget):
    def __init__(self):
        ...
        # Example data
        self._data = {'Water': 24.5, 'Eletricity': 55.1, 'Rent': 850.0,
                    'Supermarket': 230.4, 'Internet': 29.99, 'Bars': 21.85,
                    'Public transportation': 60.0, 'Coffee': 22.45, 'Restaurants': 120,
                    'lazer': 1500.0, 'House': 5321.10, 'School': 28936.59, 'Game': 682.33,
                    'Home work': 360.50, 'Club': 3771.93, 'teste1': 100, 'teste2': 539.22,
                    'teste3': 10.36}
